...
interface IProps {
  ...
  onMessageSubmitted: any,
  onDeleteConversation: any,
  loadConversations: any
}
const ChatShell: React.FC<IProps>  = ({
    conversations,
...
const mapDispatchToProps = (dispatch: any) => ({
    conversationChanged: (conversationId: string) => dispatch(conversationChanged(conversationId)),
    onMessageSubmitted: (messageText: string) => { dispatch(newMessageAdded(messageText)); },
